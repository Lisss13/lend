  ...
  class AppWithTranslation extends React.Component {
    constructor(props) {
      ...
      const changeLanguageCallback = (prevLng, newLng) => {
        ...
        if (process.browser && i18n.initializedLanguageOnce && typeof newLng === 'string' && prevLng !== newLng) {
    ...
    static async getInitialProps(ctx) {
      ...
      if (req && req.i18n) {
        initialLanguage = lngFromReq(req); // Perform a lang change in case we're not on the right lang
      ...
      if (req && req.i18n) {
        ...
        const languagesToLoad = lngsToLoad(initialLanguage, fallbackLng, config.otherLanguages); // Initialise the store with the languagesToLoad and
    ...
    render() {
      ...
      }, React.createElement(NextStaticProvider, null, React.createElement(WrappedComponentWithSSR, _extends({
